...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		healthBar.createFilledBar(0xFF015546, 0xFF6CA688);
		// healthBar
		add(healthBar);

		// Add Kade Engine watermark
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song.toLowerCase() + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "" : "Easy") + (Main.watermarks ? " - ke " + MainMenuState.kadeEngineVer : ""), 16);
