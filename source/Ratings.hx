...
class Ratings
{
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float):String
    {
        ...
        "weeds:" + (Conductor.safeFrames != 10 ? score + " (" + scoreDef + ")" : "" + score) + 									// Score
        " | joint breaks:" + PlayState.misses + 																				// Misses/Combo Breaks
        " | gas:" + (FlxG.save.data.botplay ? "n/a" : HelperFunctions.truncateFloat(accuracy, 2) + " %") +  				// Accuracy
